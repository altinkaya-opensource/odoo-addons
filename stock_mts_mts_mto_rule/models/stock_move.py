                ...
                if float_is_zero(mto_qty, precision_digits=precision):
                    if float_is_zero(mts2_qty, precision_digits=precision):  # 1
                        ...
                        if not float_is_zero(mts2_qty, precision_digits=precision):
                            move.copy(
                                default={
                                    "procure_method": split_rule.mts2_rule_id.procure_method,  # noqa
                    ...
                    if float_is_zero(
                        mts1_qty + mts2_qty, precision_digits=precision
                    ):  # 6
                        ...
                        if (
                            mts2_rule.procure_method == "make_to_stock"
                            and self.location_id.id == mts2_rule.location_src_id.id
                        ):
