...
class TrendyolRateLimiter(MarketplaceRateLimiter):
    ...
    def __init__(self, max_requests=50, time_window=10):
        super().__init__(max_requests=max_requests, time_window=time_window)
...
class TrendyolRequest(MarketplaceRequest):
    ...
    def __init__(self, seller_id, api_key, api_secret, environment="stage"):
        ...
        self.auth_header = self._build_basic_auth_header(api_key, api_secret)
